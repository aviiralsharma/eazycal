...
export default function TestHindiStep4() {
  ...
  return (
    <div className="flex flex-col min-h-full p-6">
      <div className="flex-1">
        ...
        {/* ...rest of the form remains unchanged, copy from English step-4... */}
        ...
        <div className="mt-8">
          <Link href="/prototype/test-hindi/step-3" className="text-gray-500 hover:text-gray-700 transition-colors text-sm">
            ← Back to Step 3
          </Link>
        </div>
      </div>
